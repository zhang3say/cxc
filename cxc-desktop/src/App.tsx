          ...
          <form onSubmit={handleSaveSettings} className="space-y-4">
            ...
            <DialogFooter className="pt-3">
              <div className="flex w-full items-center justify-between gap-2">
                <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground/40 font-medium select-none">
                  {appVersion && <span>v{appVersion}</span>}
                  {appVersion && <span>·</span>}
                  <button
                    type="button"
                    onClick={handleOpenGithub}
                    className="flex items-center gap-1 hover:text-muted-foreground/80 transition-colors cursor-pointer"
                    title="访问 GitHub 仓库"
                  >
